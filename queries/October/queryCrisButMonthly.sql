select
    kType,
    case
        when week_num in (27, 28, 29, 30) then 'July'
...
from
    (
        ...
        from
                    ...
                    (
                        select
                            ...
                            CASE
                                ...
                                ) = 40 then sum(complete_order_num)
                                ELSE sum(complete_order_num) / 7
                            END as daily_orders_per_week,
                            CASE
                                WHEN (
                                    CASE
                                        WHEN weekofyear(
                        ...
                        FROM
                            ...
                            LEFT JOIN (
                                ...
                                where
                                    ...
                                    and concat_ws('-', year, month, day) = '2024-06-15'
                            ) as fo_data on fo_data.shop_id = bizopp.shop_id
                        WHERE
                            country_code IN ('MX', 'CO', 'CR', 'PE')
                            and concat_ws('-', bizopp.year, bizopp.month, bizopp.day) between '2024-04-01'
                            AND '2024-06-30'
                ...
                from
                    (
                        select
                            ...
                            CASE
                                WHEN weekofyear(concat_ws('-', year, month, day)) = 40 then sum(complete_order_num)
                                ELSE sum(complete_order_num) / 7
                        ...
                        WHERE
                            country_code IN ('MX', 'CO', 'CR', 'PE')
                            and concat_ws('-', year, month, day) between '2024-04-01'
                            AND '2024-06-30'
                            and organization_type in (2, 4)
                        GROUP BY
                            shop_id,
            ...
            LEFT JOIN (
                --and shop_id = '5764607655323370349'
                select
                ...
                from
                    ...
                    LEFT JOIN (
                        ...
                        where
                            concat_ws('-', year, month, day) = '2024-06-15'
                            and country_code in ('MX', 'CO', 'CR', 'PE')
                            and organization_type in (2, 4)
